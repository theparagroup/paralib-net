        ...
        protected virtual void FindPrimaryKeys(Table table)
        {
            ...
            */
            ...
            /*
                ...
                where tc.CONSTRAINT_TYPE = 'PRIMARY KEY' and kcu.TABLE_NAME = 'authors' 
        ...
        protected virtual void FindRelationships(Table table)
        {
            ...
            */
            ...
            /*
                ...
                WHERE KCU1.TABLE_NAME='books' or KCU2.TABLE_NAME='books' order by FK_CONSTRAINT_NAME,FK_ORDINAL_POSITION;
            */
